...
@Component({
  selector: 'app-client-suggestions-internet-cable-dont-work',
  templateUrl: './client-suggestions-internet-cable-dont-work.component.html',
  styleUrls: ['./client-suggestions-internet-cable-dont-work.component.css']
})
export class ClientSuggestionsInternetCableDontWorkComponent implements OnInit {
  modemId: number;
