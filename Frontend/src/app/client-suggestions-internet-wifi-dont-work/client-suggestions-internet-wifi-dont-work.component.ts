...
@Component({
  selector: 'app-client-suggestions-internet-wifi-dont-work',
  templateUrl: './client-suggestions-internet-wifi-dont-work.component.html',
  styleUrls: ['./client-suggestions-internet-wifi-dont-work.component.css']
})
export class ClientSuggestionsInternetWifiDontWorkComponent implements OnInit {
  // Id modem
  modemId: number;
